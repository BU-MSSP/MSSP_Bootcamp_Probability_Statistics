...
--------|------------------------------------------|--------------------------------------------|
**M1**  | **Logic, Set and Probability.  Why?**    | **Understand Inductive Logic**             |
M2      | Conditional Probability and Bayes Rule   | Express Linear Regression Using Matrix     |
M3      | Inverse Matrix, Determinant, and Rank    | Solve Linear Regression                    |
M4      | Eigenvalue and Matrix Decomposition      | Learn the Computation of Linear Regression |
M5      | Vector Space, Norm, Projection           | Understand the Geometry of Regression      |
M6      | Vector and matrix of Random Variables    | Normal Linear Model                        |
M7      | Vector Calculus and MLE                  | MLE of Normal Linear Model                 |
M8      | Numerical Optimization                   | MLE of other Linear Model                  |
M9      | Linear Regression                        | Statistical Inference                      |
